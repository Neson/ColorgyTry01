...
if (window) window.courseDatabase = courseDatabase;

export default courseDatabase;

courseDatabase.updateData('NTUST').then(() => {
  courseDatabase.searchCourse('A').then(function(d) { console.log(d) })
});
courseDatabase.getPeriodData().then(function (d) { console.log(d) }).catch(function (e) { console.error(e) })
